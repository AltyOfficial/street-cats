    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('downvotes', models.ManyToManyField(blank=True, null=True, related_name='posts_downvoted', to=settings.AUTH_USER_MODEL)),
                ...
                ('upvotes', models.ManyToManyField(blank=True, null=True, related_name='posts_upvoted', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Post',
